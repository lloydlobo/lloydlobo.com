        ...
        <div className="min-h-screen">
          ...
          <div className="relative mx-auto w-fit">
            <div className="grid grid-cols-2 gap-4 ">
              <Link
                href="/work"
                className="rounded-md font-semibold uppercase text-primary underline decoration-accent underline-offset-8 shadow-sm hover:text-accent focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Work
              </Link>
              <a
                href="https://github.com/lloydlobo/"
                className="font-semibold uppercase text-primary underline decoration-accent underline-offset-8 hover:text-accent"
              >
