...
export default function IndexPage() {
  return (
    <>
      <div className="h-full min-h-screen">
        <Layout title="Home">
          <main className="relative mx-auto gap-12 h-full grid md:pt-6">
            <HeroIndex />
            <div
              className="mx-auto mt-40 flex flex-col-reverse">
              <SolarControls />
              <SolarSystem />
            </div>
          </main>
      ...
      <div className="absolute -z-50 mt-32 grayscale-[60%]"
        style={{
          position: "absolute",
          content: "",
          top: 200,
