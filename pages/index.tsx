...
export function DockNav() {
  return (
    <div className="dock z-50 absolute bottom-5 w-screen">
      <div className="bar flex  justify-evenly bg-primary/[0.00] rounded-full min-w-[300px] lg:min-w-[460px] border border-opacity-10 border-secondary/10 mx-auto px-4 py-4 w-fit bg-opacity-40 backdrop-blur-[1.5px]">
        <Link
          href="/"
