            ...
            return (
                <>
                    ...
                    >
                        {word}{" "}
                        <span
                            className={`absolute -left-[0.5rem] -right-[0.5rem] -bottom-[0.525rem] z-0 h-[0.75rem] bg-no-repeat`}
                        >
...
function GitLineVar({
    ...
    return (
        <motion.div
            ...
            // className={`absolute left-1/2 h-full w-[3px] rounded bg-blend-overlay blur-[1px] brightness-90 `}
...
const Section = ({ children }: PropsSection) => {
    ...
    return (
        ...
        >
            <div className={`grid place-items-center border border-red-400/0`}>{children}</div>
        </motion.div>
    );
};
        ...
        <Layout title="Home | ">
            <div className={`grid place-items-center space-y-[12rem] font-sans`}>
                ...
                <div className={`min-h-screen w-screen`}>
                    ...
                    <Section>
                        <h2
                            className={`font-cursive text-5xl uppercase italic text-amber-200 md:text-[7rem] `}
                        >
                            And yet ...
                        </h2>
                    </Section>
                ...
                <div className={`min-h-screen w-screen`}>
                    ...
                    <Section>
                        <div className="space-y-[12rem]">
                            <div
                                className="flex flex-wrap place-items-center text-start text-5xl
                            ...
                            <div className="max-w-screen relative grid h-full w-full text-[1.35rem] md:grid-cols-5">
                                <div
                                    className={`relative col-start-3 col-end-6 grid space-y-5 text-amber-300 `}
                                >
                                    <div
                                        className={`absolute -left-20 -top-10 grid h-14 w-14 text-amber-200`}
                                    >
                                        <AsteriskDecor />
                                    </div>
                                    <p>
                ...
                <div className={`h-screen w-screen`}>
                    ...
                    <Section>
                        <div className="flex flex-wrap place-items-center text-start text-5xl leading-[1.5ch] tracking-wide md:text-[5rem] md:leading-[1.6ch]">
                            It gets easier and
                            <br />
                            easier to ....
                            <div className={``}>
                ...
                <div>
                    <Section>
                        <div className={`mr-auto grid space-y-4 place-self-start text-start`}>
                            <div className="hidden">
                                ...
                                <p>
                                    At times, we all find good reasons to settle, but I believe that
                                    avoiding excellence is a self-reinforcing behavior that can
                                    hinder success. That's why I take a creative approach to design,
                                    using it as a shortcut to getting difficult things done.
                                </p>
                            ...
                            <h2 className={`text-5xl font-bold text-[#fbe094] `}>Highlights</h2>
                            <ul className={`list text-lg text-[#fbe094]`}>
                                ...
                                <li>
                                    Experience with cloud platforms like Docker. TODO: Azure and AWS
                                </li>
                                <li>
                ...
                <div className={`min-h-screen w-screen`}>
                    <Section>
                        <div className={`grid h-[100vh] w-screen place-items-center md:h-screen`}>
                            <h2
                                className={`text-5xl font-bold tracking-tight text-[#fbe094] hover:text-[#f6ac9f] md:text-[5.3rem]`}
                            >
                                Let's
                                <br />
                                work
                            ...
                            <div className={`relative w-full -rotate-45 text-[#fbe094]`}>
                                <div
                                    className={`absolute bottom-[10%] left-[50%] h-1/2 -translate-x-1/2`}
                                >
                                    <motion.div
                            ...
                            <button className="w-full rounded-full text-end text-xl text-[#fbe094]">
                                hello@lloydlobo.com
                            </button>
                        </div>
                    </Section>
